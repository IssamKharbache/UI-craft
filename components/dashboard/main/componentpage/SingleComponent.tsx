...
const SingleComponentPage = () => {
  ...
  const [code,setCode] = useState(`
    <div className="bg-red-100 m-4 w-1/2 px-4 py-4 rounded">
    ...
    <div className="flex flex-col gap-4 px-4 py-7 bg-red-100/80  m-4 rounded">
      ...
      <div className="flex gap-2 justify-between">
        <div className="flex items-center gap-2">
          <h1 className="text-lg font-bold">Outline Buttons</h1>
          <IconButton>
            <FavoriteBorderIcon />
          </IconButton>
        </div>
        ...
        tabMenu[0].isSelected ? (
           <div className="w-full border-2 border-red-200 rounded-xl mt-6">
            ...
            <div className="border rounded-md mt-6 w-full">
                <SyntaxHighlighter language="javascript" style={atelierCaveLight} wrapLongLines={true}>{code}</SyntaxHighlighter>
            </div>
        )
     }
    </div>
